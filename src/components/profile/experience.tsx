    ...
    <Section id="experience" title="Experience">
      <ul className="space-y-1">
        {experiences.map((exp, i) => (
          <Reveal key={exp.id} as="li" delay={i * 0.03} className="flex items-start justify-between gap-6 rounded-md px-3 py-5 transition-colors duration-300 hover:bg-card/45">
